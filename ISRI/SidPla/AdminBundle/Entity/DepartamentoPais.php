...
/**
 * ISRI\SidPla\AdminBundle\Entity\DepartamentoPais
 *
...
class DepartamentoPais
{
     ...
     * Add municipios
     *
     * @param ISRI\SidPla\AdminBundle\Entity\Municipio $municipios
     */
    public function addMunicipios(\ISRI\SidPla\AdminBundle\Entity\Municipio $municipios)
    {
     ...
     * @param ISRI\SidPla\AdminBundle\Entity\Municipio $municipios
     */
    public function addMunicipio(\ISRI\SidPla\AdminBundle\Entity\Municipio $municipios)
    {
        $this->municipios[] = $municipios;
    }
}
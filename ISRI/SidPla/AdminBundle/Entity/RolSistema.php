...
/**
 * ISRI\SidPla\AdminBundle\Entity\RolSistema
 *
...
class RolSistema
{
    ...
    private $funcionesRol; 
     ...
     /**
     * @ORM\OneToMany(targetEntity="ISRI\SidPla\UsersBundle\Entity\User", mappedBy="rol")
     */
    protected $usuarios;
     ...
     * Add usuarios
     *
     * @param ISRI\SidPla\UsersBundle\Entity\User $usuarios
     */
    public function addUsuarios(\ISRI\SidPla\UsersBundle\Entity\User $usuarios)
    {
     ...
     * Add opcionesSistema
     *
     * @param ISRI\SidPla\AdminBundle\Entity\OpcionSistema $opcionesSistema
     */
    public function addOpcionesSistema(\ISRI\SidPla\AdminBundle\Entity\OpcionSistema $opcionesSistema)
    {
     ...
     * @param ISRI\SidPla\UsersBundle\Entity\User $usuarios
     */
    public function addUser(\ISRI\SidPla\UsersBundle\Entity\User $usuarios)
    {
        $this->usuarios[] = $usuarios;
    }
     ...
     * @param ISRI\SidPla\AdminBundle\Entity\OpcionSistema $opcionesSistema
     */
    public function addOpcionSistema(\ISRI\SidPla\AdminBundle\Entity\OpcionSistema $opcionesSistema)
    {
        $this->opcionesSistema[] = $opcionesSistema;
    }
}
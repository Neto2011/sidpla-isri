...
use ISRI\SidPla\AdminBundle\EntityDao\MensajeCorreTempDao;
use ISRI\SidPla\AdminBundle\Entity\MensajeCorreTemp;
...
class AccionAdminMenCorreTempController extends Controller {
    ...
    public function consultarMenCorrtempAction(){
        ...
        return $this->render('ISRISidPlaAdminBundle:MensajeCorreoTemplate:manttMensajesCorreoTemForm.html.twig'

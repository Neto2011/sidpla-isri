...
use ISRI\SidPla\AdminBundle\Form\Type\OpcionSistemaType;
...
{    
        ...
        public function nuevaOpcAction()
	{
            ...
            $form = $this->createForm(new OpcionSistemaType() , $opc);
            return $this->render('ISRISidPlaAdminBundle:Default:opcionFormTemplate.html.twig', 
        ...
        public function mattOpcionesAction()
	{
            ...
            return $this->render('ISRISidPlaAdminBundle:Opciones:manttOpcionesSystemForm.html.twig', 

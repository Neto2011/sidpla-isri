...
use ISRI\SidPla\AdminBundle\EntityDao\RolDao;
use ISRI\SidPla\AdminBundle\Form\Type\RolSistemaType;
...
{  
	...
	public function addRolAction(Request $peticion)
	{
            ...
            return $this->redirect($this->generateUrl('ISRISidPlaAdminBundle_homepage'));	    
	}
        ...
        public function nuevoRolAction()
	{
            ...
            $form = $this->createForm(new RolSistemaType() , $rol);
            return $this->render('ISRISidPlaAdminBundle:Default:rolFormTemplate.html.twig', 
         ...
         public function mattRolesAction()
	{
            ...
            $rolDao=new RolDao($this->getDoctrine());
            $roles=$rolDao->getRoles();
            return $this->render('ISRISidPlaAdminBundle:Roles:manttRolesSystemForm.html.twig', 
                    array('roles' => $roles, 'opciones' => $opciones,));
        ...
        public function asignarOpcRolesAction(){
            ...
            return $this->render('ISRISidPlaAdminBundle:Roles:asignarOpcionesARoles.html.twig',

...
class UnidadOrganizativaDao {
    ...
    function __construct($doctrine){ 
        ...
        $this->repositorio=$this->doctrine->getRepository('ISRISidPlaAdminBundle:UnidadOrganizativa');
    } 

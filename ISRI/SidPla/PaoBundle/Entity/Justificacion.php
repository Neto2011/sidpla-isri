...
/**
 * ISRI\SidPla\PaoBundle\Entity\Justificacion
 *
 ...
 */
 public function getPao_codigo()
     ...
     * Set pao
     *
     * @param ISRI\SidPla\PaoBundle\Entity\Pao $pao
     */
    public function setPao(\ISRI\SidPla\PaoBundle\Entity\Pao $pao)
    {
        $this->pao = $pao;
    }
     ...
     * Get pao
     *
     * @return ISRI\SidPla\PaoBundle\Entity\Pao 
     */

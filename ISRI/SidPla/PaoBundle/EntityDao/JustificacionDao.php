...
use ISRI\SidPla\PaoBundle\Entity\Justificacion;// aqui defino la entidad
...
class JustificacionDao {
    ...
    function __construct($doctrine){ 
        ...
        $this->repositorio=$this->doctrine->getRepository('ISRISidPlaPaoBundle:Justificacion');// aqui pongo entidad
        // y paquete (bundle)
    } 

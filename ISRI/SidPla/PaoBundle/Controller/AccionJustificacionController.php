...
namespace ISRI\SidPla\PaoBundle\Controller; // siempre va solo cambiar el bundle al que pertenece la entidad
...
use ISRI\SidPla\PaoBundle\EntityDao\JustificacionDao;
use ISRI\SidPla\PaoBundle\Entity\Justificacion;
...
class AccionJustificacionController extends Controller {
    ...
    public function consultarJustificacionAction(){
       ...
       // $JustiDao=$JustificacioDao->getHistorialJustificacion();// aqui va el metodo que define en archivo para dao que obtiene todo    
        ...
        return $this->render('ISRISidPlaPaoBundle:Justificacion:ManttJustificacion.html.twig' //aqui se define la carpeta en que se

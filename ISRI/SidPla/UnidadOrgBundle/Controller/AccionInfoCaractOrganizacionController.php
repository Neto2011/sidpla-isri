...
use ISRI\SidPla\UnidadOrgBundle\Form\Type\InfoCaractOrgType;
use ISRI\SidPla\UnidadOrgBundle\Form\Type\CaractOrgType;
use ISRI\SidPla\UnidadOrgBundle\Entity\CaractOrg;
use ISRI\SidPla\AdminBundle\Entity\InformacionGeneral;

use ISRI\SidPla\AdminBundle\EntityDao\UnidadOrganizativaDao;
use ISRI\SidPla\AdminBundle\Entity\UnidadOrganizativa;

use ISRI\SidPla\UsersBundle\Entity\User;
use ISRI\SidPla\AdminBundle\Entity\Empleado;
use ISRI\SidPla\UnidadOrgBundle\Entity\FuncionEspecifica;
use ISRI\SidPla\UnidadOrgBundle\Entity\ObjetivoEspecifico;
use ISRI\SidPla\UnidadOrgBundle\EntityDao\CaractOrgDao;
use ISRI\SidPla\UnidadOrgBundle\EntityDao\ObjetivoEspecificoDao;
use ISRI\SidPla\UnidadOrgBundle\EntityDao\FuncionEspecificaDao;
...
class AccionInfoCaractOrganizacionController extends Controller
{
    public function ingresarInfoCaractAction()
    {
        ...
        return $this->render('ISRISidPlaUnidadOrgBundle:InforCaractOrg:ingresoInfoCaractOrg.html.twig', 
